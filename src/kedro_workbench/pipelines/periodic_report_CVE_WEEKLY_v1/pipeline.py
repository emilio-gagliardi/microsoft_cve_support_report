...
from .nodes import (fetch_section_1_periodic_report_CVE_WEEKLY_v1_data,
                    transform_section_1_periodic_report_CVE_WEEKLY_v1_data,
                    fetch_section_1_periodic_report_CVE_WEEKLY_v1_product_build_data,
                    fetch_section_1_periodic_report_CVE_WEEKLY_v1_update_packages_data,
                    build_user_prompt_data_periodic_report_CVE_WEEKLY_v1,
                    build_periodic_report_CVE_WEEKLY_v1_data_container,
                    fit_prompt_data_periodic_report_CVE_WEEKLY_v1,
                    summarize_section_1_periodic_report_CVE_WEEKLY_v1,
                    calculate_section_1_periodic_report_CVE_WEEKLY_v1,
                    fetch_section_2_periodic_report_CVE_WEEKLY_v1_data,
                    fetch_section_3_periodic_report_CVE_WEEKLY_v1_data,
                    fetch_section_4_periodic_report_CVE_WEEKLY_v1_data,
                    fetch_section_5_periodic_report_CVE_WEEKLY_v1_data,
                    calculate_section_2_periodic_report_CVE_WEEKLY_v1,
                    calculate_section_3_periodic_report_CVE_WEEKLY_v1,
                    calculate_section_4_periodic_report_CVE_WEEKLY_v1,
                    calculate_section_5_periodic_report_CVE_WEEKLY_v1,
                    compile_periodic_report_CVE_WEEKLY_v1,
                    fetch_section_6_periodic_report_CVE_WEEKLY_v1_data,
                    calculate_section_6_periodic_report_CVE_WEEKLY_v1,
                    save_periodic_report_CVE_WEEKLY_v1_data,
                    generate_periodic_report_CVE_WEEKLY_v1_html,
...
def create_pipeline(**kwargs) -> Pipeline:
    return pipeline([
        node(
                ...
                inputs=["params:product_build_product_patterns",
        ...
        node(
                ...
                inputs=["periodic_report_CVE_WEEKLY_v1_section_1_msrc_data_list",
                        "params:report_end_date",
                        "params:day_interval",
        ...
        node(
                ...
                inputs=[
                    "periodic_report_CVE_WEEKLY_v1_section_1_msrc_data_list",
                    "params:cve_metadata_keys_to_keep",
                    "params:transformed_columns_to_keep",
                    "periodic_report_CVE_WEEKLY_v1_section_1_product_build_df",
                    "periodic_report_CVE_WEEKLY_v1_section_1_update_packages_df"
                    ],
        ...
        node(
                ...
                inputs=[
                    ...
                    "params:user_prompt_metadata_keys_periodic_report_CVE_WEEKLY_v1"
                    ],
        ...
        node(
                ...
                inputs=[
                    "periodic_report_CVE_WEEKLY_v1_section_1_data_prompts_df",
                    "params:max_prompt_tokens_periodic_report_CVE_WEEKLY_v1"
                    ],
        ...
        node(
                ...
                inputs=[
                    "params:periodic_report_CVE_WEEKLY_v1_summarization_models.default",
                    "periodic_report_CVE_WEEKLY_v1_section_1_data_fitted_df",
                    "params:max_llm_output_tokens_periodic_report_CVE_WEEKLY_v1",
                    "params:llm_temperature_periodic_report_CVE_WEEKLY_v1"
                    ],
        ...
        node(
                ...
                inputs=[
                    ...
                    "params:section_1_periodic_report_CVE_WEEKLY_v1.weekdays_order"
                    ],
        ...
        node(
                ...
                inputs=["periodic_report_CVE_WEEKLY_v1_section_1_data_primary",
        ...
        node(
                ...
                inputs=["periodic_report_generated",
                        "params:report_params_periodic_report_CVE_WEEKLY_v1.sendgrid"
                        ],
                outputs=None,
        ...
        # node(
        #         func=create_draft_campaign_cve_weekly_workaround,
        #         inputs=["periodic_report_generated", "params:report_params_periodic_report_CVE_WEEKLY_v1.sendgrid"],
        #         outputs=None,
        #         name="create_draft_campaign_cve_weekly_workaround",
        #     ),
    ])
