    ...
    return pipeline(
        [
            ...
            node(
                ...
                inputs=[
                    "rss_1_data_for_aggregating",
                    "params:filename_parts_rss_1"
                    ],
                outputs=[
            ...
            node(
                ...
                inputs=[
                    "rss_2_data_for_aggregating",
                    "params:filename_parts_rss_2"
                    ],
            ...
            node(
                ...
                inputs=[
                    "rss_3_data_for_aggregating",
                    "params:filename_parts_rss_3"
                    ],
                outputs=[
            ...
            node(
                ...
                inputs=[
                    "rss_4_data_for_aggregating",
                    "params:filename_parts_rss_4"
                    ],
                outputs=[
            ...
            node(
                ...
                inputs=[
                    "edge_1_data_for_aggregating",
                    "params:filename_parts_edge_1"
                    ],
                outputs=[
            ...
            node(
                ...
                inputs=[
                    "edge_2_data_for_aggregating",
                    "params:filename_parts_edge_2"
                    ],
                outputs=[
            ...
            node(
                ...
                inputs=[
                    "edge_3_data_for_aggregating",
                    "params:filename_parts_edge_3"
                    ],
                outputs=[
            ...
            node(
                ...
                inputs=[
                    "edge_4_data_for_aggregating",
                    "params:filename_parts_edge_4"
                    ],
                outputs=[
            ...
            node(
                ...
                inputs=[
                    "edge_5_data_for_aggregating",
                    "params:filename_parts_edge_5"
                    ],
                outputs=[
            ...
            node(
                ...
                inputs=[
                    "patch_data_for_aggregating",
                    "params:filename_parts_patch"
                    ],
                outputs=[
