...
from .nodes import (
    ...
    preprocess_update_guide_product_build_data_windows10,
    preprocess_update_guide_product_build_data_windows11,
    preprocess_update_guide_product_build_data_edge,
    compile_update_guide_products_from_build_data_windows10,
    compile_update_guide_products_from_build_data_windows11,
    compile_update_guide_products_from_build_data_edge,
    compile_update_guide_build_data_windows10_node,
    compile_update_guide_build_data_windows11_node,
    compile_update_guide_build_data_edge_node,
    compile_update_guide_update_packages_windows10_node,
    compile_update_guide_update_packages_windows11_node,
    compile_update_guide_update_packages_edge_node,
    compile_update_guide_kb_article_data_windows10,
    compile_update_guide_kb_article_data_windows11,
    compile_update_guide_kb_article_data_edge,
    concatenate_update_guide_product_build_data,
    concatenate_update_guide_products_data,
    concatenate_update_guide_update_packages_data,
    concatenate_update_guide_kb_article_data,
    transform_update_guide_product_build_data_to_list,
    transform_update_guide_product_data_to_list,
    transform_update_guide_update_package_data_to_list,
    transform_update_guide_kb_articles_to_list,
    load_update_guide_product_build_data,
...
def create_pipeline(**kwargs) -> Pipeline:
    return pipeline([
        ...
        node(
            ...
            inputs=[
                "windows_10_download_node_status",
                "extract_product_build_cve_windows_10",
                "params:product_build_product_patterns.windows_10",
                "params:overwrite"
                ],
        ...
        node(
            ...
            inputs=[
                "windows_11_download_node_status",
                "extract_product_build_cve_windows_11",
                "params:product_build_product_patterns.windows_11",
                "params:overwrite"
                ],
        ...
        node(
            ...
            inputs=[
                "params:product_build_preprocess_params.windows10",
        ...
        node(
            ...
            inputs=[
                "params:product_build_preprocess_params.windows11",
        ...
        node(
            ...
            inputs=[
                "params:product_build_preprocess_params.edge",
        ...
        node(
            ...
            inputs=[
                "params:compile_products_params.windows10",
        ...
        node(
            ...
            inputs=[
                "params:compile_products_params.windows11",
        ...
        node(
            ...
            inputs=[
                "params:compile_products_params.edge",
        ...
        node(
            ...
            inputs=[
                "params:compile_kb_articles_params.windows10",
                "prepped_product_build_cve_windows_10_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:compile_kb_articles_params.windows11",
                "prepped_product_build_cve_windows_11_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:compile_kb_articles_params.edge",
                "prepped_product_build_cve_edge_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:compile_product_build_params.windows10",
                "prepped_product_build_cve_windows_10_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:compile_product_build_params.windows11",
                "prepped_product_build_cve_windows_11_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:compile_product_build_params.edge",
                "prepped_product_build_cve_edge_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:compile_update_package_params.windows10",
                "prepped_product_build_cve_windows_10_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:compile_update_package_params.windows11",
                "prepped_product_build_cve_windows_11_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:compile_update_package_params.edge",
                "prepped_product_build_cve_edge_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:concatenate_product_build_params",
                "product_builds_windows10_df",
                "product_builds_windows11_df",
                "product_builds_edge_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:concatenate_products_params",
                "products_windows10_df",
                "products_windows11_df",
                "products_edge_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:concatenate_kb_article_params",
                "kb_articles_windows10_df",
                "kb_articles_windows11_df",
                "kb_articles_edge_df"
                ],
        ...
        node(
            ...
            inputs=[
                "params:concatenate_update_package_params",
                "update_packages_windows_10_df",
                "update_packages_windows_11_df",
                "update_packages_edge_df"
                ],
        ...
        node(
            ...
            inputs=[
                "concatenated_product_build_df"
                ],
            outputs=[
                "transformed_product_builds_for_loading",
                "wait_for_transform"
                ],
        ...
        node(
            ...
            inputs=[
                "concatenated_update_packages_df"
                ],
